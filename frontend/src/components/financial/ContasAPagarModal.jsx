                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <label htmlFor="naoPagasModal" className="text-xs">
                          Não Pagas
                        </label>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <label htmlFor="pagasModal" className="text-xs">
                          Pagas
                        </label>
                      </div>
                    </div>
                ...
                <CardContent className="p-3">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <RadioGroupItem
                        value="vencimento"
                        id="ordVencimentoModal"
                      />
                      <label htmlFor="ordVencimentoModal" className="text-xs">
                        Vencimento
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <RadioGroupItem value="codigo" id="ordCodigoModal" />
                      <label htmlFor="ordCodigoModal" className="text-xs">
                        Código
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <RadioGroupItem
                        value="fornecedor"
                        id="ordFornecedorModal"
                      />
                      <label htmlFor="ordFornecedorModal" className="text-xs">
                        Fornecedor
                      </label>
                    </div>
                    <div className="flex items-center gap-2">
                      <RadioGroupItem value="valor" id="ordValorModal" />
                      <label htmlFor="ordValorModal" className="text-xs">
                        Valor
                      </label>
                    </div>
                  </RadioGroup>
