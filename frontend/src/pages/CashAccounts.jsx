...
export default function CashAccountsPage() {
  ...
  const [originalAccountBeforeEdit, setOriginalAccountBeforeEdit] =
    useState(null);
  ...
  const loadAccounts = async () => {
    try {
      ...
      const data = await CashAccount.filter(
    ...
    try {
      ...
      if (isEditing) {
        ...
        const oldInitialBalance =
          originalAccountBeforeEdit?.initialBalance || 0;
        ...
        const newCurrentBalance =
          (originalAccountBeforeEdit?.balance || 0) + initialBalanceDifference;
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-600">
              Gerencie suas contas, caixas e carteiras
            </p>
          </div>
          <Button
            onClick={() => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setCurrentAccount((prev) => ({ ...prev, type: value }))
                      }
                      required
                    >
