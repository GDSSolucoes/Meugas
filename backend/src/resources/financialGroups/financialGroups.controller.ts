...
export class FinancialgroupsController extends BaseCrudController<typeof financialGroups> {
  ...
  @ApiResponse({ status: 201, description: `Financialgroup created`, type: FinancialgroupCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Financialgroup retrieved`, type: FinancialgroupCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of financialGroups`, type: [FinancialgroupCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Financialgroup updated`, type: FinancialgroupUpdateDto })
