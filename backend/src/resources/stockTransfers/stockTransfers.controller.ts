...
export class StocktransfersController extends BaseCrudController<typeof stockTransfers> {
  ...
  @ApiResponse({ status: 201, description: `Stocktransfer created`, type: StocktransferCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Stocktransfer retrieved`, type: StocktransferCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of stockTransfers`, type: [StocktransferCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Stocktransfer updated`, type: StocktransferUpdateDto })
