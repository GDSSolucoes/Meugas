...
export class OrdersController extends BaseCrudController<typeof orders> {
  ...
  @ApiResponse({ status: 201, description: `Order created`, type: OrderCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Order retrieved`, type: OrderCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of orders`, type: [OrderCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Order updated`, type: OrderUpdateDto })
