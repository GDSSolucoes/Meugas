...
export class CashmovementsController extends BaseCrudController<typeof cashMovements> {
  ...
  @ApiResponse({ status: 201, description: `Cashmovement created`, type: CashmovementCreateDto })
  async create(@Body() data: CashmovementCreateDto) {
    return super.create(data)
  }

  @Get(':id')
  @ApiOperation({ summary: `Get Cashmovement by ID` })
  @ApiResponse({ status: 200, description: `Cashmovement retrieved`, type: CashmovementCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of cashMovements`, type: [CashmovementCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Cashmovement updated`, type: CashmovementUpdateDto })
  async update(@Param('id') id: string, @Body() data: CashmovementUpdateDto) {
