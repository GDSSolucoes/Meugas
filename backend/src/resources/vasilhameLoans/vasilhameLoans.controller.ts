...
export class VasilhameloansController extends BaseCrudController<typeof vasilhameLoans> {
  ...
  @ApiResponse({ status: 201, description: `Vasilhameloan created`, type: VasilhameloanCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Vasilhameloan retrieved`, type: VasilhameloanCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of vasilhameLoans`, type: [VasilhameloanCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Vasilhameloan updated`, type: VasilhameloanUpdateDto })
