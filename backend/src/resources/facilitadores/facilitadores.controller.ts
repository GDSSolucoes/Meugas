...
export class FacilitadorEsesController extends BaseCrudController<
  typeof facilitadores
> {
  ...
  @ApiResponse({
    status: 200,
    description: `FacilitadorEs retrieved`,
    type: FacilitadorEsCreateDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: `List of facilitadores`,
    type: [FacilitadorEsCreateDto],
  })
  @ApiQuery({
    name: "page",
