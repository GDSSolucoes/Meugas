...
export class PaymenttypEsesController extends BaseCrudController<typeof paymentTypes> {
  ...
  @ApiResponse({ status: 201, description: `PaymenttypEs created`, type: PaymenttypEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `PaymenttypEs retrieved`, type: PaymenttypEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of paymentTypes`, type: [PaymenttypEsCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `PaymenttypEs updated`, type: PaymenttypEsUpdateDto })
