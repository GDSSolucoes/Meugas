...
export class ProductpickupsController extends BaseCrudController<typeof productPickups> {
  ...
  @ApiResponse({ status: 201, description: `Productpickup created`, type: ProductpickupCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Productpickup retrieved`, type: ProductpickupCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of productPickups`, type: [ProductpickupCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Productpickup updated`, type: ProductpickupUpdateDto })
