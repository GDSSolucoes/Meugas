...
export class SectormastersController extends BaseCrudController<
  typeof sectorMasters
> {
  ...
  @ApiResponse({
    status: 200,
    description: `Sectormaster retrieved`,
    type: SectormasterCreateDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: `List of sectorMasters`,
    type: [SectormasterCreateDto],
  })
  @ApiQuery({
    name: "page",
  ...
  @ApiResponse({
    status: 201,
    description: `Sectormaster updated`,
    type: SectormasterUpdateDto,
  })
  async update(@Param("id") id: string, @Body() data: SectormasterUpdateDto, @CurrentUser() user: any) {
