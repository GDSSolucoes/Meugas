...
export class ProductstocksController extends BaseCrudController<typeof productStocks> {
  ...
  @ApiResponse({ status: 201, description: `Productstock created`, type: ProductstockCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Productstock retrieved`, type: ProductstockCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of productStocks`, type: [ProductstockCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Productstock updated`, type: ProductstockUpdateDto })
