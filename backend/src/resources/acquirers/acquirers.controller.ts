...
export class AcquirersController extends BaseCrudController<typeof acquirers> {
  ...
  @ApiResponse({ status: 201, description: `Acquirer created`, type: AcquirerCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Acquirer retrieved`, type: AcquirerCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of acquirers`, type: [AcquirerCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Acquirer updated`, type: AcquirerUpdateDto })
