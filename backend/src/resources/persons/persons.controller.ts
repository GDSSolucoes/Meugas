...
export class PersonsController extends BaseCrudController<typeof persons> {
  ...
  @ApiResponse({ status: 201, description: `Person created`, type: PersonCreateDto })
  ...
  @ApiResponse({ status: 200, description: `Person retrieved`, type: PersonCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of persons`, type: [PersonCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Person updated`, type: PersonUpdateDto })
