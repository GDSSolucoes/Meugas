...
export const productCategoriesPGEnum = pgEnum(
  "product_categories",
...
export const products = pgTable(
  "products",
  {
    ...
    costPrice: numeric("cost_price", { mode: "number" }).default(0),
    ...
    icmsOrigem: icmsOrigemPGEnum("icms_origem").default(
      IcmsOrigemEnum.ORIGEM_0,
    ),
    beneficioFiscal: text("beneficio_fiscal"),
    anpCodigo: text("anp_codigo"),
    anpDescricao: text("anp_descricao"),
    valorSemIcmsKg: numeric("valor_sem_icms_kg", { mode: "number" }).default(0),
    kgPorUnidadeGlp: numeric("kg_por_unidade_glp", { mode: "number" }).default(
      0,
    ),
    percentualGlp: numeric("percentual_glp", { mode: "number" }).default(0),
    percentualGnNacional: numeric("percentual_gn_nacional", {
      mode: "number",
    }).default(0),
    percentualGnImportado: numeric("percentual_gn_importado", {
      mode: "number",
    }).default(0),
    codif: text("codif"),
    pesoLiquido: numeric("peso_liquido", { mode: "number" }).default(0),
    pesoBruto: numeric("peso_bruto", { mode: "number" }).default(0),
