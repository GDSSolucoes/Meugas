...
export const StockMovementTypePGEnum = pgEnum("stock_movement_type", StockMovementTypeEnum);
...
export const productStockMovements = pgTable(
  "productStockMovements",
  {
    ...
    productPickupId: uuid("product_pickup_id").references(() => productPickups.id, {
      onDelete: "cascade",
    }),
    vasilhameLoanId: uuid("vasilhame_loan_id").references(() => vasilhameLoans.id, {
      onDelete: "cascade",
    }),
