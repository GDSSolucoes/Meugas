...
export default function PaymentModal({
  ...
  const isCardPayment =
    selectedPaymentType && selectedPaymentType.type?.includes("cartao");
  ...
  if (paymentType) {
    console.log("🔍 DEBUG DETALHADO PaymentModal:", {
      ...
      isCardPayment,
      allPaymentTypes: paymentTypes.map((t) => ({
        id: t.id,
        name: t.name,
        type: t.type,
      })),
  ...
  useEffect(() => {
    if (pedido) {
      const valorFormatado = (pedido.totalAmount || 0)
        .toFixed(4)
        .replace(".", ",");
  ...
  const troco =
    totalRecebido > totalAReceber ? totalRecebido - totalAReceber : 0;
  ...
  const handleConfirm = () => {
    ...
    if (hasAddedCardPayment && cartoesData.length > 0) {
      const hasIncompleteData = cartoesData.some(
        (cartao) => !cartao.bandeira || !cartao.codigoLiberacao,
      );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
          ...
          <div className="col-span-1 flex flex-col">
            <div className="space-y-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    ...
                    if (selectedType) {
                      ...
                      if (
                        selectedType.type === "cartao_debito" ||
                        selectedType.type === "cartao_credito"
                      ) {
                        setPaymentOption("prazo");
                      } else {
                        setPaymentOption(
                          selectedType.maxInstallments > 1 ? "prazo" : "vista",
                        );
                      }
                    }
                  }}
              ...
              <div className="space-y-2">
                <RadioGroup
                  value={paymentOption}
                  className="flex gap-6 pointer-events-none opacity-60"
                >
            ...
            <div className="mt-auto space-y-4 pt-6">
              ...
              <div className="space-y-2 border-t pt-4">
                ...
                <div className="flex justify-between text-sm font-semibold">
                  ...
                  <span
                    className={
                      saldoRestante > 0 ? "text-red-600" : "text-green-600"
                    }
                  >
          ...
          <div className="col-span-2 flex flex-col">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-gray-500 italic">
                (Selecione e pressione DEL para excluir)
              </span>
            </div>
            ...
            <div className="flex-1 flex flex-col">
              {hasAddedCardPayment ? (
                ...
                >
                  ...
                  <TabsContent
                    value="parcelas"
                    className="flex-1 overflow-auto border rounded mt-0"
                  >
                        ...
                        <TableBody>
                          {parcelas.length === 0 ? (
                            <TableRow>
                              <TableCell
                                colSpan={3}
                                className="text-center text-gray-400 h-28"
                              >
                                Nenhuma parcela
                              </TableCell>
                            </TableRow>
                              ...
                              <TableRow key={idx}>
                                ...
                                <TableCell className="p-1">
                                  <Select
                                    ...
                                    onValueChange={(value) =>
                                      handleBandeiraChange(idx, value)
                                    }
                                  >
        ...
        <div className="flex justify-end items-center pt-4 border-t">
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="text-white"
              style={{
                backgroundColor: isConfirmEnabled ? "#223f61" : "#94a3b8",
              }}
            >
              Confirmar
            </Button>
      ...
      <Dialog open={showCardDataWarning} onOpenChange={setShowCardDataWarning}>
        <DialogContent className="max-w-md">
          ...
          <div className="py-4">
            <p className="text-center">
              Por favor, preencha a bandeira e o código de liberação para todas
              as parcelas do cartão antes de confirmar.
            </p>
          </div>
      ...
      <Dialog open={showCancelConfirm} onOpenChange={setShowCancelConfirm}>
        <DialogContent className="max-w-md">
          ...
          <div className="py-4">
            <p className="text-center">
              Deseja realmente cancelar? Todas as informações de pagamento serão
              perdidas.
            </p>
          </div>
          <div className="flex justify-end gap-2">
