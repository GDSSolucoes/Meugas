...
export class Purchase extends BaseEntity {
   ...
   */
  static async filter(filters: Partial<Purchase> = {}, pagination = {})  : Promise<Purchase[]> {
    return super._filter.call(this, this.baseUrl, filters, pagination) as Promise<Purchase[]>;
  }
  ...
  static async update(id: string, data: Partial<Purchase>): Promise<Purchase> {
    return super._update.call(this, this.baseUrl, id, data) as Promise<Purchase>;
  }
  ...
  static async findById(id: string): Promise<Purchase | null> {
    return super._findById.call(this, this.baseUrl, id) as Promise<Purchase | null>;
  }
}
