...
export default function ProductsPage() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      setVasilhames(
        productsData.filter((p) => p.category === "vasilhame" && p.active),
      );
    } catch (error) {
    ...
    try {
      if (!currentUser || !currentUser.companyId) {
        toast({
          title: "Erro",
          description:
            "Não foi possível identificar a empresa do usuário para a exclusão.",
          variant: "destructive",
        });
        return;
      }
      ...
      if (window.confirm("Tem certeza que deseja excluir este produto?")) {
        ...
        const stocksToDelete = productStocks.filter(
  ...
  const handleCategoryChange = (value) => {
    setCurrentProduct((prev) => ({
      ...
      vasilhameName:
        value === "glp" || value === "agua" ? prev.vasilhameName : "",
    }));
  };
  ...
  const getCategoryBadge = (category) => {
    ...
    return (
      <Badge className={colors[category]}>{labels[category] || category}</Badge>
    );
  };
                  ...
                  <TabsContent value="dados" className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {(currentProduct.category === "glp" ||
                          currentProduct.category === "agua") && (
                          <div>
                            ...
                            {vasilhames.length === 0 && (
                              <p className="text-sm text-amber-600 mt-1">
                                ⚠️ Cadastre primeiro os vasilhames para poder
                  ...
                  <TabsContent value="tributacao" className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="3">
                                3 - Nacional com Conteúdo de Importação 40-70%
                              </SelectItem>
                              <SelectItem value="4">
                                4 - Nacional, produção conforme processos
                                básicos
                              </SelectItem>
                              <SelectItem value="5">
                              ...
                              <SelectItem value="6">
                                6 - Estrangeira - Importação direta (CAMEX/gás)
                              </SelectItem>
                              <SelectItem value="7">
                                7 - Estrangeira - Mercado interno (CAMEX/gás)
                              </SelectItem>
                              <SelectItem value="8">
                        ...
                        <div>
                          <Label htmlFor="unidadeTributavel">
                            Unidade Tributável
                          </Label>
                          <Input
                            ...
                            onChange={(e) =>
                              setCurrentProduct((prev) => ({
                                ...prev,
                                unidadeTributavel: e.target.value.toUpperCase(),
                              }))
                            }
                            placeholder="UN"
                            maxLength={6}
                        ...
                        <div className="md:col-span-1">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setCurrentProduct((prev) => ({
                                ...prev,
                                beneficioFiscal: e.target.value.toUpperCase(),
                              }))
                            }
                      ...
                      <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-sm text-blue-800">
                          <strong>ℹ️ Informação:</strong> Os códigos{" "}
                          <strong>CFOP</strong>, <strong>CST</strong> (ICMS,
                          PIS, COFINS) e <strong>IPI</strong> são definidos nos
                          <strong> Facilitadores Fiscais</strong> e serão
                          aplicados automaticamente na emissão das notas.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="outras" className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setCurrentProduct((prev) => ({
                                ...prev,
                                valorSemIcmsKg: parseFloat(e.target.value) || 0,
                              }))
                            }
                            placeholder="R$ 0,00"
                            className="bg-white/80"
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setCurrentProduct((prev) => ({
                                ...prev,
                                percentualGlp: parseFloat(e.target.value) || 0,
                              }))
                            }
                            placeholder="0,00 %"
                            className="bg-white/80"
                        ...
                        <div>
                          <Label htmlFor="percentualGnNacional">
                            % GN Nacional
                          </Label>
                          <Input
                        ...
                        <div>
                          <Label htmlFor="percentualGnImportado">
                            % GN Importado
                          </Label>
                          <Input
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2">
                          <Label htmlFor="informacoesAdicionaisNfe">
                          ...
                          <Textarea
                            ...
                            onChange={(e) =>
                              setCurrentProduct((prev) => ({
                                ...prev,
                                informacoesAdicionaisNfe: e.target.value,
                              }))
                            }
                            rows={4}
                          ...
                          />
                          <p className="text-xs text-slate-500 mt-1">
                            Estas informações serão incluídas no campo
                            "Informações Complementares" da NF-e/NFC-e
                          </p>
                        </div>
                      </div>
                    </div>
