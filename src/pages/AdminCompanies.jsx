    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Administração de Empresas</h1>
            <p className="text-slate-300 text-lg">Controle total do sistema multi-empresa</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link to={createPageUrl("DataMigration")}>
              <Button variant="outline" className="bg-yellow-600/20 hover:bg-yellow-600/30 text-yellow-300 border-yellow-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white">Total de Empresas</CardTitle>
          ...
          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white">Empresas Ativas</CardTitle>
              <CheckCircle className="h-4 w-4 text-green-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-400">{stats.activeCompanies}</div>
            </CardContent>
          </Card>

          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white">Empresas Suspensas</CardTitle>
              <AlertCircle className="h-4 w-4 text-red-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-red-400">{stats.suspendedCompanies}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-400">R$ {stats.totalRevenue.toFixed(2)}</div>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="mb-8 bg-white/90 backdrop-blur-sm border-slate-200/60">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setCurrentCompany(prev => ({ ...prev, document: e.target.value }))}
                      required
                      className="bg-white/80"
                    />
                  </div>
                ...
                <h3 className="text-lg font-semibold -mb-2">Administrador Principal</h3>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                ...
                <h3 className="text-lg font-semibold -mb-2">Plano e Pagamento</h3>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setCurrentCompany(prev => ({ ...prev, notes: e.target.value }))}
                    className="bg-white/80"
                    rows={3}
                  />
                </div>
                    ...
                    <TableRow key={company.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          <Button variant="ghost" size="icon" onClick={() => handleEdit(company)} className="hover:bg-blue-100">
                          ...
                          {company.status === 'suspensa_pagamento' && (
                            <Button 
                              variant="ghost" 
                              size="icon" 
                              onClick={() => handleStatusChange(company.id, 'ativa')}
                          ...
                          <Button variant="ghost" size="icon" onClick={() => handleDelete(company.id)} className="hover:bg-red-100">
