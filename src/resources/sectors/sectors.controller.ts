...
export class SectorsController extends BaseCrudController<typeof sectors> {
  ...
  @ApiResponse({ status: 201, description: `Sector created`, type: SectorCreateDto })
  async create(@Body() data: SectorCreateDto) {
    return super.create(data)
  }

  @Get(':id')
  @ApiOperation({ summary: `Get Sector by ID` })
  @ApiResponse({ status: 200, description: `Sector retrieved`, type: SectorCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of sectors`, type: [SectorCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Sector updated`, type: SectorUpdateDto })
