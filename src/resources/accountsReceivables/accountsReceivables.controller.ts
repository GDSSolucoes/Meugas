...
export class AccountsreceivablEsesController extends BaseCrudController<typeof accountsReceivables> {
  ...
  @ApiResponse({ status: 201, description: `AccountsreceivablEs created`, type: AccountsreceivablEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `AccountsreceivablEs retrieved`, type: AccountsreceivablEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of accountsReceivables`, type: [AccountsreceivablEsCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `AccountsreceivablEs updated`, type: AccountsreceivablEsUpdateDto })
  async update(@Param('id') id: string, @Body() data: AccountsreceivablEsUpdateDto) {
