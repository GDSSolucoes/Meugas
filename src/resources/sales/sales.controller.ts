...
export class SalEsesController extends BaseCrudController<typeof sales> {
  ...
  @ApiResponse({ status: 201, description: `SalEs created`, type: SalEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `SalEs retrieved`, type: SalEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of sales`, type: [SalEsCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `SalEs updated`, type: SalEsUpdateDto })
