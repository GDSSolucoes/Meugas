...
export class PurchasEsesController extends BaseCrudController<typeof purchases> {
  ...
  @ApiResponse({ status: 201, description: `PurchasEs created`, type: PurchasEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `PurchasEs retrieved`, type: PurchasEsCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of purchases`, type: [PurchasEsCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `PurchasEs updated`, type: PurchasEsUpdateDto })
