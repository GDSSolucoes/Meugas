...
export class UsersController {
  constructor(private readonly users: UsersService, private readonly jwt: JwtService, private readonly rls: RlsService) {}
  ...
  async list(@CurrentUser() user: any) {
    ...
    return rows.map(r => ({ id: r.id, email: r.email, name: r.name, role: r.role, companyId: r.companyId, active: r.active }))
  }
}
