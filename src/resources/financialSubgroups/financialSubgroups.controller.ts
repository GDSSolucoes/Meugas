...
export class FinancialsubgroupsController extends BaseCrudController<typeof financialSubgroups> {
  ...
  @ApiResponse({ status: 201, description: `Financialsubgroup created`, type: FinancialsubgroupCreateDto })
  async create(@Body() data: FinancialsubgroupCreateDto) {
    return super.create(data)
  }

  @Get(':id')
  @ApiOperation({ summary: `Get Financialsubgroup by ID` })
  @ApiResponse({ status: 200, description: `Financialsubgroup retrieved`, type: FinancialsubgroupCreateDto })
  ...
  @ApiResponse({ status: 200, description: `List of financialSubgroups`, type: [FinancialsubgroupCreateDto] })
  ...
  @ApiResponse({ status: 201, description: `Financialsubgroup updated`, type: FinancialsubgroupUpdateDto })
  async update(@Param('id') id: string, @Body() data: FinancialsubgroupUpdateDto) {
