...
export const products = pgTable("products", {
  ...
  kgPorUnidadeGlp: numeric("kg_por_unidade_glp", { mode : "number"}).default(0),
  percentualGlp: numeric("percentual_glp", { mode : "number"}).default(0),
  percentualGnNacional: numeric("percentual_gn_nacional", { mode : "number"}).default(0),
  percentualGnImportado: numeric("percentual_gn_importado", { mode : "number"}).default(0),
  codif: text("codif"),
