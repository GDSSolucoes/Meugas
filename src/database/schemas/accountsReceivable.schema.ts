...
export const AccountsReceivableStatusPGEnum = pgEnum('accounts_receivable_status', AccountsReceivableStatusEnum)
...
export const accountsReceivables = pgTable('accountsReceivables', {
  ...
  status: AccountsReceivableStatusPGEnum('status').notNull().default(AccountsReceivableStatusEnum.PENDENTE),
